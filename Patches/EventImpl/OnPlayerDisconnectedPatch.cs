...
{
    public class OnPlayerDisconnectedPatch : EventPatch
    {
        ...
        public OnPlayerDisconnectedPatch() : base(MeasurableObjectType.PlayerDisconnectedEvent, new HarmonyMethod(typeof(OnPlayerDisconnectedPatch), nameof(HijackPrefix)), new HarmonyMethod(typeof(OnPlayerDisconnectedPatch), nameof(HijackPostfix)))
        {
        ...
        {
            DoPostfix(__instance, __state, MeasurableObjectType.PlayerDisconnectedEvent);
        }
    }
}