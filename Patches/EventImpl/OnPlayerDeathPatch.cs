...
{
    public class OnPlayerDeathPatch : EventPatch
    {
        ...
        public OnPlayerDeathPatch() : base(MeasurableObjectType.PlayerDeathEvent, new HarmonyMethod(typeof(OnPlayerDeathPatch), nameof(HijackPrefix)), new HarmonyMethod(typeof(OnPlayerDeathPatch), nameof(HijackPostfix)))
        {
        ...
        {
            DoPostfix(__instance, __state, MeasurableObjectType.PlayerDeathEvent);
        }
    }
}