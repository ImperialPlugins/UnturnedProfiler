...
{
    public class OnBeforePlayerConnectedPatch : EventPatch
    {
        ...
        public OnBeforePlayerConnectedPatch() : base(MeasurableObjectType.BeforePlayerConnectedEvent, new HarmonyMethod(typeof(OnBeforePlayerConnectedPatch), nameof(HijackPrefix)), new HarmonyMethod(typeof(OnBeforePlayerConnectedPatch), nameof(HijackPostfix)))
        {
        ...
        {
            DoPostfix(__instance, __state, MeasurableObjectType.BeforePlayerConnectedEvent);
        }
    }
}