...
{
    public class OnPlayerRevivePatch : EventPatch
    {
        ...
        public OnPlayerRevivePatch() : base(MeasurableObjectType.PlayerReviveEvent, new HarmonyMethod(typeof(OnPlayerRevivePatch), nameof(HijackPrefix)), new HarmonyMethod(typeof(OnPlayerRevivePatch), nameof(HijackPostfix)))
        {
        ...
        {
            DoPostfix(__instance, __state, MeasurableObjectType.PlayerReviveEvent);
        }
    }
}