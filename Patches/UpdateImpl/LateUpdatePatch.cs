...
{
    public class LateUpdatePatch : UpdateBasePatch
    {
        public LateUpdatePatch() : base(new HarmonyMethod(typeof(LateUpdatePatch), nameof(HijackPrefix)), new HarmonyMethod(typeof(LateUpdatePatch), nameof(HijackPostfix)))
        {
        }
        ...
        {
            DoPostfix(__instance, __state, MeasurableObjectType.FrameLateUpdate);
        }

        public override MeasurableObjectType MeasureType
            => MeasurableObjectType.FrameLateUpdate;
    }
}